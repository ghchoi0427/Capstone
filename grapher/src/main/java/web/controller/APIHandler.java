...
public class APIHandler {
    ...
    private static final String COORD_X = "62";
    private static final String COORD_Y = "122";

    public static String sendRequest(String date, String time) {
        ///ex) date = 20211001 time = 0600
